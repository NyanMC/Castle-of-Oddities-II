...
local animations = {
	-- Big only animations
	walk = {32,33,34,35,31,36,37,38,39,31, frameDelay = 3},
	run  = {11,12,14,16,17, frameDelay = 3},
	walkHolding = {41,9,43,44,45,41,46,47,48,49, frameDelay = 3},
	fall = {27},
	duckSmall = {8},

	-- Small only animation
	walkSmall = {32,33,34,35,31,36,37,38,39,31,   frameDelay = 3},
	runSmall  = {11,12,14,16,17, frameDelay = 3},
	walkHoldingSmall = {41,9,43,44,45,41,46,47,48,49, frameDelay = 3},

	fallSmall = {27},

	-- SMB2 characters (like toad)
	walkSmallSMB2 = {2,11,2,1,12,21,12,1,   frameDelay = 6},
	runSmallSMB2  = {2,11,2,1,12,21,12,1, frameDelay = 6},
	...
	kick = {5,5,42,42,42, frameDelay = 3,loops = false},

	runJump = {11,12,14,16,17, frameDelay = 2},
	...
	shootGround = {3,5,9,9,9, frameDelay = 6,loops = true},
	shootAir    = {3,5,9,9,9, frameDelay = 6,loops = false},
	shootWater  = {47,47,47, frameDelay = 6,loops = false},
	...
	-- Swimming
	swimIdle = {30, frameDelay = 10},
	swimStroke = {18,19,20,28,29,30, frameDelay = 4,loops = false},
	swimStrokeSmall = {18,19,20,28,29,30, frameDelay = 4,loops = false},
